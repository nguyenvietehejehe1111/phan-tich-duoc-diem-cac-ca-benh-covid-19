...
if 'Nhóm tuổi' in df.columns:
    ...
    current_year = 2025  # Cập nhật năm hiện tại (ngày 15/03/2025)
...
# Bỏ plt.style.use('seaborn') vì không hợp lệ, sử dụng seaborn trực tiếp
sns.set_style("whitegrid")  # Sử dụng kiểu của seaborn thay vì matplotlib
plt.rcParams['font.family'] = 'Arial'  # Đặt font chữ (có thể thay bằng 'Times New Roman')

# Biểu đồ cột cho Giới tính
...
# Biểu đồ kết hợp Giới tính và Nhóm tuổi (pivot table)
